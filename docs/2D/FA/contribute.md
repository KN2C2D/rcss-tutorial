...
برای ویرایش فایل‌های متنی شما میتوانید از [Typora](https://support.typora.io/Typora-on-Linux/) بهمراه [این تم](https://theme.typora.io/theme/Middle-East/) استفاده کنید؛ این تم و ابزار معرفی شده می‌تواند فرایند مشارکت شما را بسیار دلپذیرتر کند.
